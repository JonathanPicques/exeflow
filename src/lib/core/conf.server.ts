...
export const triggerUrl = ensureValid(env.EXEFLOW_TRIGGER_URL, string, 'EXEFLOW_TRIGGER_URL env must be a non-empty string');
export const webhookUrl = ensureValid(env.EXEFLOW_WEBHOOK_URL, string, 'EXEFLOW_WEBHOOK_URL env must be a non-empty string');
